//spinner page//
let spinerpage =document.createElement("div");

spinerpage.classList.add("loding-spinner");
spinerpage.innerHTML=`<div class="content">
                            <div class="sk-circle">
...
document.body.appendChild(spinerpage);

window.addEventListener("load",()=>{
   setTimeout(()=>{
        spinerpage.style.display="none";
